<template>
  <div class="app">
    <WidgetMain :events="events" :one="'dddddd'" />
  </div>
</template>
    ...
    return {
      events: [
        ...
        },
        {
          ...
          eventText: `10 августа 2022 года, с 10 часов до 21 часов в Москве и ТиНАО и в Московской области ожидается сильный ветер с порывами 12 - 15 м/с.`,
          iconCode: 2,
        },
        {
          eventType: 3,
